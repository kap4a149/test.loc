...
function getParsedLastThreeNews(){
  ...
  $result = $stmt->fetchAll();
    echo "<div class=\"newsName\">" . $result[0][0] . '</div>' . '<br />' . "<div class = \"newsDate\">" . $result[0][1] . '</div>' . '<br />' . "<img class=\"newsImage\" src=" . $result[0][2] . '>' . '<br />' . $result[0][3] .'<br />';
    echo "<div class=\"newsName\">" . $result[1][0] . '</div>' . '<br />' . "<div class = \"newsDate\">" . $result[1][1] . '</div>' . '<br />' . "<img class=\"newsImage\" src=" . $result[1][2] . '>' . '<br />' . $result[1][3] .'<br />';
    echo "<div class=\"newsName\">" . $result[2][0] . '</div>' . '<br />' . "<div class = \"newsDate\">" . $result[2][1] . '</div>' . '<br />' . "<img class=\"newsImage\" src=" . $result[2][2] . '>' . '<br />' . $result[2][3] .'<br />';
}
